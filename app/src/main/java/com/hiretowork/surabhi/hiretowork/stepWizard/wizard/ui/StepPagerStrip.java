...
public class StepPagerStrip extends View {
    ...
    public StepPagerStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPrevTabPaint.setColor(res.getColor(R.color.blue_trans));

        mSelectedTabPaint = new Paint();
        mSelectedTabPaint.setColor(res.getColor(R.color.colorAccent));

        mSelectedLastTabPaint = new Paint();
        mSelectedLastTabPaint.setColor(res.getColor(R.color.green));

        mNextTabPaint = new Paint();
        mNextTabPaint.setColor(res.getColor(R.color.gray));
    }
