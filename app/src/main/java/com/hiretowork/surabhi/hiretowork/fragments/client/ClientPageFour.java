...
public class ClientPageFour extends Fragment {


    public ClientPageFour() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textview_head_title.setText(R.string.page4_head);
        ...
        cb1.setText(R.string.personal_website);
        cb2.setText(R.string.blog_page);
        cb3.setText(R.string.social_website);
        cb4.setText(R.string.ecommerse_web);
        cb5.setText(R.string.business_Web);
