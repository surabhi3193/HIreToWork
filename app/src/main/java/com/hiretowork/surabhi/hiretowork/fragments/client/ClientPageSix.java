...
public class ClientPageSix extends Fragment {


    public ClientPageSix() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textview_head_title.setText(R.string.page6_head);
        ...
        cb1.setText("I'll provide all the content");
        cb2.setText("I'll provide most of  the content");
        cb3.setText("I'll provide some of  the content");
        cb4.setText("I would like the designer to create the content for me");
